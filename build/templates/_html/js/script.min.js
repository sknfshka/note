...
i.stopImmediatePropagation();var n=t(this);setTimeout(function(){e.isPlay&&(n.is(":focus")?(e.autoPlayClear(),e.paused=!0):(e.paused=!1,e.autoPlay()))},0)})},t.fn.slick=function(){var t,i=this,n=arguments[0],o=Array.prototype.slice.call(arguments,1),s=i.length,r=0;for(r;r<s;r++)if("object"==typeof n||"undefined"==typeof n?i[r].slick=new e(i[r],n):t=i[r].slick[n].apply(i[r].slick,o),"undefined"!=typeof t)return t;return i}}),document.addEventListener("DOMContentLoaded",function(){function t(t){t.preventDefault();var e=document.getElementById("textEnter"),i=[],n=e.textContent.match(/#[А-Яа-я0-9ё\w]+/g);null!==n&&n.forEach(function(t,e){var n=!1;i.forEach(function(e){t==e.text&&(n=!0)}),0==n&&i.push({text:t,id:e})});var o={id:void 0==l.length?0:l.length,text:e.textContent,tags:i};l.push(o),localStorage.setItem("notes",JSON.stringify(l)),r(o),e.innerHTML=null}function e(t){if(t.focus(),"undefined"!=typeof window.getSelection&&"undefined"!=typeof document.createRange){var e=document.createRange();e.selectNodeContents(t),e.collapse(!1);var i=window.getSelection();i.removeAllRanges(),i.addRange(e)}else if("undefined"!=typeof document.body.createTextRange){var n=document.body.createTextRange();n.moveToElementText(t),n.collapse(!1),n.select()}}function i(t){var e=t.target,i=e.parentNode;l.splice(s(i.dataset.id,l),1),localStorage.setItem("notes",JSON.stringify(l)),i.remove()}function n(t){var e=t.target,i=e.parentNode,n=i.getElementsByClassName("noteText")[0],o=i.getElementsByClassName("tagList")[0];if("true"==n.getAttribute("contentEditable")){e.classList.remove("act"),n.classList.remove("underline"),n.setAttribute("contentEditable",!1);var r=n.textContent,c=r.replace(/<span class="hashtag">(#[А-Яа-я0-9ё\w]+)<\/span>/g,"$1");n.innerHTML=c;var d=s(i.dataset.id,l);l[d].text=n.innerText;var u=n.textContent.match(/#[А-Яа-я0-9ё\w]+/g);null!==u&&u.forEach(function(t){var e=!1;l[d].tags.forEach(function(i){t==i.text&&(e=!0)}),0==e&&(l[d].tags.push({text:t,id:l[d].tags.length}),a(o,d,{text:t,id:l[d].tags.length-1}))}),localStorage.setItem("notes",JSON.stringify(l))}else{e.classList.add("act"),n.classList.add("underline"),n.setAttribute("contentEditable",!0);var r=n.textContent,c=r.replace(/(#[А-Яа-я0-9ё\w]+)/g,'<span class="hashtag">$1</span>');n.innerHTML=c}}function o(){var t=this.textContent,i=t.replace(/(#[А-Яа-я0-9ё\w]+)/g,'<span class="hashtag">$1</span>');this.innerHTML=i,e(this)}function s(t,e){if(void 0!=e&&null!=e&&void 0!=t){for(var i=0;i<e.length;i++)if(e[i].id==t)return i;return null}}function r(t){var e=document.createElement("li");e.setAttribute("id","note-"+t.id),e.classList.add("note"),recodsList.appendChild(e),e.dataset.id=t.id;var r=document.createElement("p");r.classList.add("noteText"),r.innerHTML=t.text,r.addEventListener("keyup",o),e.appendChild(r);var c=document.createElement("a");c.innerHTML="X",c.classList.add("del"),e.appendChild(c),c.addEventListener("click",i);var d=document.createElement("a");d.innerHTML="E",d.classList.add("edit"),e.appendChild(d),d.addEventListener("click",n);var u=document.createElement("span");u.classList.add("smbl"),u.innerHTML="#",e.appendChild(u);var p=document.createElement("div");p.classList.add("newTagText"),p.setAttribute("contentEditable",!0),e.appendChild(p);var f=document.createElement("a");f.classList.add("addNewTag"),f.innerHTML="+",f.addEventListener("click",function(t){var e=t.target.parentNode,i=e.getElementsByClassName("tagList")[0],n=s(e.dataset.id,l),o=e.getElementsByClassName("newTagText")[0],r="#"+o.textContent;if(null!==r){var c=!1;l[n].tags.forEach(function(t){r==t.text&&(c=!0)}),0==c&&(l[n].tags.push({text:r,id:l[n].tags.length}),a(i,n,{text:r,id:l[n].tags.length-1}),localStorage.setItem("notes",JSON.stringify(l)))}o.textContent=null}),e.appendChild(f);var h=document.createElement("ul");h.classList.add("tagList"),e.appendChild(h),null!==t.tags&&0!==t.tags.length&&t.tags.forEach(function(e,i){a(h,t.id,e)})}function a(t,e,i){var n=document.createElement("li");n.setAttribute("id","tag-"+i.id),n.classList.add("tag"),n.innerHTML=i.text,n.dataset.id=i.id,n.dataset.note=e;var o=document.createElement("a");o.classList.add("delTag"),o.innerHTML="x",o.addEventListener("click",function(t){var e=t.target,i=e.parentNode,n=s(i.dataset.note,l),o=s(Number(i.dataset.id),l[n].tags),r=l[n].tags[o].text;l[n].tags.splice(o,1);var a=new RegExp(r,"g"),c=l[n].text.replace(a,r.substr(1));l[n].text=c;var d=document.getElementById("note-"+i.dataset.note).getElementsByTagName("p")[0];d.innerText=d.innerText.replace(a,r.substr(1)),localStorage.setItem("notes",JSON.stringify(l)),i.remove()}),n.appendChild(o),t.appendChild(n)}recodsList=document.getElementById("recordsList"),document.getElementById("submitEnter").addEventListener("click",t);var l=JSON.parse(localStorage.getItem("notes"));null==l&&(l=[]),l.forEach(function(t,e){r(l[e])});var c=document.getElementById("filterEnter");c.addEventListener("focus",function(){"Enter tag through gap"==this.textContent&&(this.textContent="")}),c.addEventListener("blur",function(){""==this.textContent&&(this.textContent="Enter tag through gap")}),document.getElementById("submitFilter").addEventListener("click",function(){var t=document.getElementById("filterEnter"),e=t.textContent.match(/#[А-Яа-я0-9ё\w]+/g);if(null!=e)l.forEach(function(t){var i,n=!1;for(i=0;i<e.length;i++){for(var o=!1,s=0;s<t.tags.length;s++)if(e[i]==t.tags[s].text){o=!0;break}if(0==o){n=!0;break}}var r=document.getElementById("note-"+t.id);1==n?r.classList.add("notActive"):r.classList.remove("notActive")});else{var i=document.getElementsByClassName("note");if(null!==i){var n;for(n=0;n<i.length;n++)"Enter tag through gap"==t.textContent?i[n].classList.remove("notActive"):i[n].classList.add("notActive")}}});var d=document.getElementById("textEnter");d.addEventListener("keyup",function(){var t=this.textContent,i=t.replace(/(#[А-Яа-я0-9ё\w]+)/g,'<span class="hashtag">$1</span>');this.innerHTML=i,e(this)});var u=document.getElementsByClassName("del");if(null!==u){var p;for(p=0;p<u.length;p++)u[p].addEventListener("click",i)}});